...
let Draggable = Draggable_1 = class Draggable extends Base {
    ...
    getMousePosition(evt) {
        let intCoord = this.getCoordinates(evt);
        let pageX = this.clone ? intCoord.pageX : (intCoord.pageX + window.scrollX) - this.relativeXPosition;
        let pageY = this.clone ? intCoord.pageY : (intCoord.pageY + window.scrollY) - this.relativeYPosition;
        return {
